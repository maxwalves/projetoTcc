...
<div class="col-md-10 offset-md-1 dashboard-avs-container">
    ...
    <a href="{{ url('/clientes/historico/' . $historico->cliente_id) }}" class="btn btn-warning"><i class="fas fa-arrow-left"></i></a>

    
    <form action="{{ url("/clientes/updateHistorico/".$historico->id) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        ...
        <a href="{{ url('/clientes/historico/' . $historico->cliente_id) }}" class="btn btn-secondary">Cancelar</a>
    </form>
</div>
@stop
