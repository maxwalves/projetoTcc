...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            #logo {
                width: 100%; /* Define o tamanho inicial para dispositivos móveis */
                margin: 0 auto;
            }

            @media screen and (min-width: 768px) {
                /* Quando a largura da tela for igual ou superior a 768px (tela de computador) */
                #logo {
                    width: 30%; /* Define o tamanho para telas de computador */
                }
            }
        </style>
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registre-se</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <img id="logo" src="{{ asset('/img/1.png') }}" alt="">
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <a class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Economize tempo!</h2>

                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    O sistema facilita a sua vida, economizando tempo e dinheiro.
                                </p>
                            </div>
                        ...
                        <div class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Aumente a produtividade da sua empresa!</h2>

                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    Com o nosso sistema você foca no que realmente importa e deixa a parte burocrática com a gente.
                                </p>
                            </div>
                        </div>
                    </div>
